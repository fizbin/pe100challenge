...
I could maybe do something clever here with vectors of prime powers,
but I think I'm just going to make a HashSet of `rug::Integer`s.

...

Yep. Hardest thing was finding again the syntax for `Cargo.toml` to
include `rug`.
