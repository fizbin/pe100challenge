...
Well this is sticky. I suppose it'll get me into some stuff I haven't with rust before,
like pattern matching et. al., and also more i/o, which I haven't touched in ages.

Still, it looks like the most annoying kind of problem: lots of special cases with
little room to be very clean about it.

...

Well that took way too long. It was in fact royally messy, and pattern matching did
not in fact turn out to be that useful. I did learn (from the rustlang discord)
some interesting things about `Ord` and `PartialOrd`, and some things like
the use of `Cell` around closures that modify their environment.

The code is though still really messy. I'm going to go ask around to see if anyone else
